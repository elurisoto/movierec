...
%   OUTPUTALEXPREPROCESSED = IMPORTFILE1(FILENAME) Reads data from text
%   file FILENAME for the default selection.
%
%   OUTPUTALEXPREPROCESSED = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads
%   data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   outputAlexPreprocessed = importfile1('outputAlexPreprocessed.csv', 2,
%   1060);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2015/05/30 15:09:33
